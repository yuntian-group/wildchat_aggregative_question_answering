...
export const AnnotationExampleDisplay: React.FC = () => {
    const dialogueData = useAppSelector((state: RootState) => state.fewshotExampleDataFetch.data);
    const dialogueDataStatus = useAppSelector((state: RootState) => state.fewshotExampleDataFetch.status);
